...
IF(RAGEL_FOUND)
	...
	MACRO(RAGEL_PARSER SRCFILE)
		...
		SET(OUTGRAPH "${CMAKE_CURRENT_BINARY_DIR}/${SRCPATH}/${SRCBASE}.dot")
		...
		ADD_CUSTOM_COMMAND(OUTPUT ${OUTFILE}
			COMMAND "${RAGEL_EXECUTABLE}" ARGS -C ${_flags} -o "${OUTFILE}" "${INFILE}"
			COMMAND "${RAGEL_EXECUTABLE}" ARGS -Vp ${_flags} -o "${OUTGRAPH}" "${INFILE}"
			DEPENDS "${INFILE}"
